...
export default function ResumeSection({ id, secondaryId }: ResumeSectionProps) {
  const experiences = [
    {
      hex: "0xBF20",
      title: "Co-founder & CTO | ClaimClam [NEXTJS/TAILWINDCSS/GO/TF/AWS]",
  ...
  return (
    <div id={id} className="mt-8">
      ...
      <div className="mb-4">
        <span className="block opacity-60 font-mono">{experiences[0].hex}</span>
        <h2 className="text-xl font-medium">{">"}RESUME</h2>
        {/* <span className="block opacity-60  font-mono">0xCA10</span> */}
      ...
      {experiences.map((exp) => (
        <div key={exp.hex} className="mb-8">
          <div className="flex flex-col md:flex-row md:items-start">
            ...
            <span className="hidden md:block opacity-60 mr-3 font-mono">
              {exp.hex}
            </span>
